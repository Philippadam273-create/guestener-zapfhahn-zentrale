...
export default function Home() {
   ...
   * WICHTIG:
   *
   * Die Summe der bezahlten Beträge darf niemals
   * die tatsächlichen Eventkosten übersteigen.
   *
   * Zahlungen werden ausschließlich aus den
   * persönlichen Verbrauchskosten erzeugt.
   */
  const paidAmount =
    payments
      .filter(
